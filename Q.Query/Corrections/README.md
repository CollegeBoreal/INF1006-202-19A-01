...
```
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1064 (42000) at line 28: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '�léphone  INT,
                      PRIMARY KEY(IDclient)
                 ' at line 3
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1146 (42S02) at line 24: Table 'network_IT.CLIENTS' doesn't exist
```
...
```
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1064 (42000) at line 100: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'CREATE TABLE IF NOT EXISTS Hijabfashion.PAYS_DE_FABRICATION (
  pays_de_fabricat' at line 12
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1146 (42S02) at line 35: Table 'Hijabfashion.COULEURS' doesn't exist
```
...
mysql: [Warning] Using a password on the command line interface can be insecure.
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1452 (23000) at line 98: Cannot add or update a child row: a foreign key constraint fails (`Boubou`.`MODELE`, CONSTRAINT `MODELE_ibfk_1` FOREIGN KEY (`genre`) REFERENCES `GENRE` (`genre`))
```
...
mysql: [Warning] Using a password on the command line interface can be insecure.
mysql: [Warning] Using a password on the command line interface can be insecure.
ERROR 1452 (23000) at line 65: Cannot add or update a child row: a foreign key constraint fails (`widesign`.`INVOICES`, CONSTRAINT `invoices_ibfk_1` FOREIGN KEY (`customer`) REFERENCES `customers` (`customer`))
```
